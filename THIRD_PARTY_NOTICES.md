...
This **source scaffold archive** does not bundle third-party source files, font files, model files or compiled dependencies. `deps/lock.json` records intended upstream dependencies and their declared license information; [dependency provenance](docs/dependencies.md) records the source of each pin.
